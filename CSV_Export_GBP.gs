...
function saveAsCSVGBP() {
  ...
  var sheet = ss.getSheetByName("GBP-Transactions");
  var cell = sheet.getRange(2, 9).getValue();
  Logger.log(cell);
  if(cell == "YES"){
    
    
    var filename = "GBP_Transactions_" + today + ".csv"; // CSV file name
    var Cfilename = "GBP_Transactions.csv"; // Constant CSV file name
    var folder = ""; // Folder ID 
    
    var csv = "";
    var v = SpreadsheetApp
    .getActiveSpreadsheet()
    .getSheetByName("GBP-TRX")
    .getDataRange()
    .getValues();
  ...
  if(cell == "NO"){ 
    ...
    var Bfilename = "GBP_Transactions.csv"; // Constant CSV file name
    var folder = ""; // Folder ID 
    var csv = "";
